...
# ------------------ Empathy Quotes ------------------
quotes = [
    "🌟 Small steps every day lead to a healthier you tomorrow.",
    "🧠 Your body hears everything your mind says — stay positive.",
    "🏃 Recovery is not a race, be patient with yourself.",
    "💙 You showed up for your health today, that already makes a difference.",
    "🌙 Rest, hydrate, and trust the process — you've got this.",
    "🔋 Energy comes from habits, not motivation. Keep going.",
    "🩺 Checking in on your health is an act of self-respect."
]
